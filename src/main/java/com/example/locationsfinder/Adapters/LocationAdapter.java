...
public class LocationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LocationAdapter(Activity activity, Set<Location> locations, itemClickRV listener) {
    ...
    private void setUserLocation() {
        ...
        if(((MainActivity)activity).getMyLats() != 0) {
            userLocation[0] = ((MainActivity) activity).getMyLats();
            userLocation[1] = ((MainActivity) activity).getMyLongs();
        }
        else{
    ...
    public static class LocationViewHolder extends RecyclerView.ViewHolder {
        ...
        public LocationViewHolder(@NonNull View itemView) {
            ...
            TextView no_info_text = (TextView) itemView.findViewById(R.id.no_info_text);
            ...
            btn_favorite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (favLocationList.add(getItemsAt(mainActivity.getLocationList(), position))) {
                        myRef.child(user.getUserId()).child("Locations").child(String.valueOf(favLocationList.size() - 1)).setValue(getItemsAt(mainActivity.getLocationList(), position));

//                        if(favLocationList.size() == 1)
//                            no_info_text.setText(view.GONE);
                        if(mainActivity.favoriteLocationAdapter != null) {
                            mainActivity.favoriteLocationAdapter.notifyDataSetChanged();
                            Toast.makeText(mainActivity, "Successfully added", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(mainActivity, "Go to see your favorites first!", Toast.LENGTH_SHORT).show();

                        }


                    } else {
                        Toast.makeText(mainActivity, "This place already in your favorite list", Toast.LENGTH_SHORT).show();
                    }
